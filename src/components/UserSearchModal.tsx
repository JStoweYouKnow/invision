...
export const UserSearchModal: React.FC<UserSearchModalProps> = ({ isOpen, onClose, onSelectUser }) => {
    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-[10000] flex items-center justify-end p-4 md:p-8 pointer-events-none">
                    ...
                    <div className="p-6 border-b border-slate-100 shrink-0">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-full text-sm focus:outline-none focus:border-brand-purple focus:ring-2 focus:ring-brand-purple/20 text-slate-900 placeholder:text-slate-400"
                            />
                            {isSearching && (
